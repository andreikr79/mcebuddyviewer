...
using MCEBuddy.TagLib.Image;
using MCEBuddy.TagLib.IFD;
using MCEBuddy.TagLib.IFD.Entries;
using MCEBuddy.TagLib.IFD.Tags;
using MCEBuddy.TagLib.Xmp;

namespace MCEBuddy.TagLib.Tiff
{
	/// <summary>
