...
namespace MCEBuddy.Transcode
{
    public class TrimVideo
    {
        ...
        public bool Trim(string sourceVideo, int startTrim, int endTrim)
        {
            ...
            string tempFile = Util.FilePaths.GetFullPathWithoutExtension(sourceVideo) + "-temp.ts"; // only support trimming TS file for now
            ...
            string ffmpegParams = "-y -i " + Util.FilePaths.FixSpaces(sourceVideo) + " -map 0:a -map 0:v -vcodec copy -acodec copy -copytb -1 -f mpegts";
