...
namespace MCEBuddy.VideoProperties
{
    ...
    {
        private string _conversionTool = "";
        private string _originalFileName = "";
        private string _videoCodec = "";
        private string _audioCodec = "";
        private float _audioDelay = 0;
        ...
        private bool _copyProtected = false;
        private bool _error = false;
        private bool _adsRemoved = false;
        private bool _audioDelaySet = false;
        ...
        private bool skipCropping = false;
        private FFmpegMediaInfo originalFileFFmpegStreamInfo = null;
        private FFmpegMediaInfo ffmpegStreamInfo = null;
        private int audioStream = -1; // Stream number of the selected Audio Channel
        private int audioTrack = -1; // Audio track number of the selected Audio Channel (0 based reference, i.e. 0 indicates 1st audio)
        private int videoStream = -1; // Stream number for the video stream (there is only 1 video stream per file)
        private int videoPID = -1; // Video stream PID
        private int audioPID = -1; // Audio stream PID
        ...
        {
            updateVideoFile("", videoFileName, "", "", "", ref jobStatus, jobLog);
        }
        ...
        {
            updateVideoFile(profile, videoFileName, remuxedFileName, edlFile, audioLanguage, ref jobStatus, jobLog);
        }
        ...
        public void updateVideoFile(string profile, string videoFileName, string remuxedFileName, string edlFile, string audioLanguage, ref JobStatus jobStatus, Log jobLog)
        {
            _error = false;
            ...
            else if (_error) // If there was an irrecoverable original error from MediaInfo
            {
            ...
            else // if MediaInfo succeeded but got height/width 0 and FFMpeg failed, we can still live with it
        ...
        public bool AdsRemoved
        {
            ...
            set { _adsRemoved = value; }
        }

        public bool AudioDelaySet
        {
            get { return _audioDelaySet; }
            set { _audioDelaySet = value; }
        }

        public string RemuxedFileName
        {
            get { return _remuxedFileName; }
            set { _remuxedFileName = value; }
        }

        public string ConversionTool
        {
            get { return _conversionTool; }
            set { _conversionTool = value; }
        }
