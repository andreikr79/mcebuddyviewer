...
namespace MCEBuddy.Globals
{
    public static class GlobalDefs
    {
        ...
        public const string MCEBUDDY_TCP_PIPE = "net.tcp://" + MCEBUDDY_SERVER_NAME + ":" + MCEBUDDY_SERVER_PORT + "/MCEBuddy2x";
        public const string MCEBUDDY_NAMED_PIPE = "net.pipe://" + MCEBUDDY_SERVER_NAME + "/MCEBuddy2x";
        ...
        public const SecurityMode MCEBUDDY_PIPE_SECURITY = SecurityMode.None; // Security for Pipe communication using WCF
